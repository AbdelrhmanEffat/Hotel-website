...
function autoScrollTo(el) {
	...
	var currentY = window.pageYOffset,
        targetY = document.getElementById(el).offsetTop,
        bodyHeight = document.body.offsetHeight,
        yPos = currentY + window.innerHeight,
        
        animator = setTimeout('autoScrollTo(\'' + el + '\')', speed);// recursively calling with speed
...
function resetScroller(el) {
	...
	var currentY = window.pageYOffset,
        targetY = document.getElementById(el).offsetTop,
        animator = setTimeout('resetScroller(\'' + el + '\')', speed);
